  ...
  function (e, t, i, s) {
    ...
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
      ...
      for (var r = e.length - 1; r >= 0; r--)
        (o = e[r]) && (n = (a < 3 ? o(n) : a > 3 ? o(t, i, n) : o(t, i)) || n);
...
let NinjaKeys = class extends LitElement {
  ...
  open(e = {}) {
    ...
    (this._bump = !0),
      ...
      null === (t = this._headerRef.value) ||
        void 0 === t ||
        t.setSearch(null !== (i = e.search) && void 0 !== i ? i : ""),
      (this._search = null !== (s = e.search) && void 0 !== s ? s : ""),
      setTimeout(() => {
        var e, t;
        null ===
          (t =
            null === (e = this._wrapperRef.value) || void 0 === e
              ? void 0
              : e.querySelector(".actions-list")) ||
          void 0 === t ||
          t.scrollTo({ top: 0 });
      }, 0);
  }
  ...
  get breadcrumbs() {
    ...
    if (i)
      for (t.push(i); i; ) {
        ...
        (null == e ? void 0 : e.parent) && t.push(e.parent),
          (i = e ? e.parent : void 0);
      }
    return t.reverse();
  }
    ...
    this.openHotkey &&
      ...
      this.goBackHotkey &&
        hotkeys(this.goBackHotkey, (e) => {
          this.visible &&
            (this._search || (e.preventDefault(), this._goBack()));
        }),
  ...
  render() {
    ...
    (null !== (e = this._ignorePrefixesSplit) && void 0 !== e) ||
      ...
      null === (t = this._ignorePrefixesSplit) ||
        void 0 === t ||
        t.some((e) => !!n.startsWith(e) && ((n = n.substring(e.length)), !0)),
      (n = n.trim());
    const r = {},
      c = [];
    (this._currentRoot
      ? null !==
          (s =
            null === (i = this.data.find((e) => e.id === this._currentRoot)) ||
            void 0 === i
              ? void 0
              : i.children) && void 0 !== s
        ? s
      ...
      if ("function" == typeof e) {
        ...
        return (
          null === (i = s.children) ||
            void 0 === i ||
            i.splice(t, 1, "loading"),
          (a.isLoadingItems = !0),
          void e().then((e) => {
            var i;
            null === (i = s.children) || void 0 === i || i.splice(t, 1, ...e),
              this.render();
          })
        );
      }
      const s = commandScore(e.title + " " + e.description, n);
      ((!this._currentRoot && n) || e.parent === this._currentRoot) &&
        ((r[e.title] = s.indices),
        s.score > 0 && c.push({ score: s.score, item: e }));
    });
    const h = (
      n
        ? c.sort((e, t) =>
            e.score === t.score
              ? e.item.title.localeCompare(t.item.title)
              : t.score - e.score,
          )
        : c
    )
      .map((e) => e.item)
      .reduce(
        (e, t) => e.set(t.section, [...(e.get(t.section) || []), t]),
        new Map(),
      );
        ...
        html` ${repeat(
          ...
          (e, t) => {
            ...
            return html`${s}<ninja-action
                ...
                .selected=${live(
                  e.id ===
                    (null === (i = this._selected) || void 0 === i
                      ? void 0
                      : i.id),
                )}
    ...
    if (
      (this.dispatchEvent(
        new CustomEvent("selected", {
          detail: { search: this._search, action: e },
          bubbles: !0,
          composed: !0,
        }),
      ),
      ...
      if (
        (e.children &&
          (null === (t = e.children) || void 0 === t ? void 0 : t.length) > 0 &&
          ((this._currentRoot = e.id), (this._search = "")),
        this._headerRef.value.setSearch(""),
        this._headerRef.value.focusSearch(),
        e.handler)
      ) {
  ...
  _overlayClick(e) {
    ...
    (null === (t = e.target) || void 0 === t
      ? void 0
      : t.classList.contains("modal")) && this.close();
  }
};
(NinjaKeys.styles = [baseStyles]),
  ...
  __decorate(
    [property({ type: Array, hasChanged: () => !0 })],
    NinjaKeys.prototype,
    "data",
    void 0,
  ),
