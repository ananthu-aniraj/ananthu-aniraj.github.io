...
const d = new Map(),
  y = (e) =>
    i[e.toLowerCase()] || c[e.toLowerCase()] || e.toUpperCase().charCodeAt(0);
function h(e) {
  p = e || "all";
}
function m() {
...
function k(e) {
  if (void 0 === e)
    ...
    "function" == typeof r && ((i = r), (r = "")),
      g({ key: e, scope: r, method: i, splitKey: "+" });
  }
}
const g = (e) => {
  ...
  if (t.scope === n || "all" === t.scope) {
    ...
    for (const e in l)
      Object.prototype.hasOwnProperty.call(l, e) &&
        ((!l[e] && t.mods.indexOf(+e) > -1) ||
          (l[e] && -1 === t.mods.indexOf(+e))) &&
        (r = !1);
...
function O(e, t) {
  ...
  for (const t in l)
    Object.prototype.hasOwnProperty.call(l, t) && (l[t] = e[s[t]]);
  e.getModifierState &&
    (!e.altKey || e.ctrlKey) &&
    e.getModifierState("AltGraph") &&
    (-1 === a.indexOf(17) && a.push(17),
    -1 === a.indexOf(18) && a.push(18),
    (l[17] = !0),
    (l[18] = !0));
  const r = m();
  if (n)
    for (let o = 0; o < n.length; o++)
      n[o].scope === r &&
        (("keydown" === e.type && n[o].keydown) ||
          ("keyup" === e.type && n[o].keyup)) &&
        w(e, n[o], r, t);
  if (!(o in f)) return;
  const i = f[o],
    u = i.length;
  for (let n = 0; n < u; n++)
    if (
      (("keydown" === e.type && i[n].keydown) ||
        ("keyup" === e.type && i[n].keyup)) &&
      i[n].key
    ) {
      const o = i[n],
        { splitKey: c } = o,
...
function b(e, n, i) {
  ...
  if (void 0 !== m && window) {
    if (!d.has(m)) {
      ...
      d.set(m, { keydownListener: e, keyupListenr: n, capture: K }),
        t(m, "keydown", e, K),
        t(m, "keyup", n, K);
    }
    if (!u) {
...
const E = {
  getPressedKeyString: function () {
    return a.map((e) => {
      return (
        (t = e),
        Object.keys(i).find((e) => i[e] === t) ||
          ((e) => Object.keys(c).find((t) => c[t] === e))(e) ||
  ...
  filter: function (e) {
    ...
    return (
      (t.isContentEditable ||
        ((r || "TEXTAREA" === n || "SELECT" === n) && !t.readOnly)) &&
        (o = !1),
      o
    );
  },
...
if ("undefined" != typeof window) {
  ...
  (b.noConflict = (t) => (
    t && window.hotkeys === b && (window.hotkeys = e), b
  )),
    (window.hotkeys = b);
}
export { b as default };
