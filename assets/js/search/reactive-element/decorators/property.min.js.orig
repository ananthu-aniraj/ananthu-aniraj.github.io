...
class P extends HTMLElement {
  ...
  _$EC(t, e) {
    ...
    if (void 0 !== i && !0 === s.reflect) {
      const r = (
        void 0 !== s.converter?.toAttribute ? s.converter : S
  ...
  return (e, s) =>
    "object" == typeof s
      ...
      : ((t, e, s) => {
          ...
          return (
            e.constructor.createProperty(s, i ? { ...t, wrapped: !0 } : t),
            i ? Object.getOwnPropertyDescriptor(e, s) : void 0
          );
        })(t, e, s);
}
