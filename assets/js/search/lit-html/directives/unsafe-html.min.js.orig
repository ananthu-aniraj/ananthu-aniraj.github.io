  ...
  for (let e = 0; e < s; e++) {
        ...
        $ === _
          ...
          : $ === p
            ? ">" === A[0]
              ...
              : void 0 === A[1]
                ? (a = -2)
                : ((a = $.lastIndex - A[2].length),
                  (c = A[1]),
                  ($ = void 0 === A[3] ? p : '"' === A[3] ? v : g))
            : $ === v || $ === g
              ? ($ = p)
              : $ === d || $ === u
                ? ($ = _)
    ...
    l +=
      $ === _
        ? s + o
        : a >= 0
          ? (r.push(c), s.slice(0, a) + i + s.slice(a) + n + y)
          : s + n + (-2 === a ? e : y);
  }
      ...
      if (1 === h.nodeType) {
        if (h.hasAttributes())
          for (const t of h.getAttributeNames())
            if (t.endsWith(i)) {
              ...
              t.startsWith(n) &&
                (a.push({ type: 6, index: $ }), h.removeAttribute(t));
        if (f.test(h.tagName)) {
        ...
        if (h.data === r) a.push({ type: 2, index: $ });
          ...
          for (; -1 !== (t = h.data.indexOf(n, t + 1)); )
            a.push({ type: 7, index: $ }), (t += n.length - 1);
        }
      $++;
    }
  }
...
class C {
    ...
    const { values: e, _$litType$: s } = t,
      i =
        "number" == typeof s
          ? this._$AC(t)
          : (void 0 === s.el &&
              (s.el = E.createElement(T(s.h, s.h[0]), this.options)),
            s);
  ...
  k(t) {
    ...
    for (const n of t)
      i === e.length
        ? e.push((s = new C(this.S(l()), this.S(l()), this, this.options)))
        : (s = e[i]),
        s._$AI(n),
        i++;
 ...
 */ class O extends P {
  constructor(t) {
    if ((super(t), (this.it = y), t.type !== B.CHILD))
      throw Error(
