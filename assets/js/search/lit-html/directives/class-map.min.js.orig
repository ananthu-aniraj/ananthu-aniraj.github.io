  ...
  for (let e = 0; e < s; e++) {
        ...
        $ === _
          ...
          : $ === u
            ? ">" === A[0]
              ...
              : void 0 === A[1]
                ? (c = -2)
                : ((c = $.lastIndex - A[2].length),
                  (a = A[1]),
                  ($ = void 0 === A[3] ? u : '"' === A[3] ? f : g))
            : $ === f || $ === g
              ? ($ = u)
              : $ === d || $ === p
                ? ($ = _)
    ...
    l +=
      $ === _
        ? s + o
        : c >= 0
          ? (r.push(a), s.slice(0, c) + i + s.slice(c) + n + y)
          : s + n + (-2 === c ? e : y);
  }
    ...
    const { values: e, _$litType$: s } = t,
      i =
        "number" == typeof s
          ? this._$AC(t)
          : (void 0 === s.el &&
              (s.el = b.createElement(T(s.h, s.h[0]), this.options)),
            s);
 ...
 */ const P = j(
  class extends O {
    constructor(t) {
      if (
        (super(t),
        t.type !== L.ATTRIBUTE || "class" !== t.name || t.strings?.length > 2)
      )
        throw Error(
    ...
    update(t, [e]) {
      ...
      for (const t in e) {
        ...
        i === this.st.has(t) ||
          this.nt?.has(t) ||
          (i ? (s.add(t), this.st.add(t)) : (s.remove(t), this.st.delete(t)));
      }
      return m;
    }
  },
