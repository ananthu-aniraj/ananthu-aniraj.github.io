  ...
  for (let e = 0; e < s; e++) {
    ...
    l +=
      $ === a
        ? s + o
        : _ >= 0
          ? (h.push(c), s.slice(0, _) + i + s.slice(_) + n + y)
          : s + n + (-2 === _ ? e : y);
  }
        ...
        if (r.hasAttributes())
          for (const t of r.getAttributeNames())
            if (t.endsWith(i)) {
              ...
              t.startsWith(n) &&
                (_.push({ type: 6, index: $ }), r.removeAttribute(t));
        if (v.test(r.tagName)) {
...
function M(t, e, s = t, i) {
  ...
  return (
    n?.constructor !== h &&
      (n?._$AO?.(!1),
      void 0 === h ? (n = void 0) : ((n = new h(t)), n._$AT(t, s, i)),
    ...
    const { values: e, _$litType$: s } = t,
      i =
        "number" == typeof s
          ? this._$AC(t)
          : (void 0 === s.el &&
              (s.el = C.createElement(N(s.h, s.h[0]), this.options)),
            s);
...
function j(t, e = !1, s = 0) {
  ...
  if (void 0 !== n && 0 !== n.size)
    if (e)
      if (Array.isArray(i))
        for (let t = s; t < i.length; t++) P(i[t], !1), W(i[t]);
    ...
    class extends Z {
      ...
      get lt() {
        return "function" == typeof this.Y
          ? q.get(this.ht ?? globalThis)?.get(this.Y)
          : this.Y?.value;
      }
      disconnected() {
