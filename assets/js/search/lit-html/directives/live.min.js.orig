  ...
  for (let e = 0; e < i; e++) {
        ...
        $ === c
          ...
          : $ === p
            ? ">" === _[0]
              ...
              : void 0 === _[1]
                ? (f = -2)
                : ((f = $.lastIndex - _[2].length),
                  (A = _[1]),
                  ($ = void 0 === _[3] ? p : '"' === _[3] ? g : u))
            : $ === g || $ === u
              ? ($ = p)
              : $ === a || $ === d
                ? ($ = c)
    ...
    l +=
      $ === c
        ? i + o
        : f >= 0
          ? (r.push(A), i.slice(0, f) + s + i.slice(f) + n + y)
          : i + n + (-2 === f ? e : y);
  }
...
class M {
    ...
    const { values: e, _$litType$: i } = t,
      s =
        "number" == typeof i
          ? this._$AC(t)
          : (void 0 === i.el &&
              (i.el = b.createElement(H(i.h, i.h[0]), this.options)),
            i);
  ...
  k(t) {
    ...
    for (const n of t)
      s === e.length
        ? e.push((i = new M(this.S(l()), this.S(l()), this, this.options)))
        : (i = e[s]),
        i._$AI(n),
        s++;
 ...
 */ const L = {},
  P = (
    ...
    class extends D {
      constructor(t) {
        if ((super(t), t.type !== W && t.type !== B && t.type !== j))
          throw Error(
