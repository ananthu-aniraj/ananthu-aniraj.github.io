  ...
  for (let e = 0; e < s; e++) {
        ...
        $ === a
          ...
          : $ === p
            ? ">" === _[0]
              ...
              : void 0 === _[1]
                ? (c = -2)
                : ((c = $.lastIndex - _[2].length),
                  (A = _[1]),
                  ($ = void 0 === _[3] ? p : '"' === _[3] ? g : f))
            : $ === g || $ === f
              ? ($ = p)
              : $ === d || $ === u
                ? ($ = a)
    ...
    l +=
      $ === a
        ? s + r
        : c >= 0
          ? (o.push(A), s.slice(0, c) + i + s.slice(c) + n + y)
          : s + n + (-2 === c ? e : y);
  }
      ...
      if (1 === h.nodeType) {
        if (h.hasAttributes())
          for (const t of h.getAttributeNames())
            if (t.endsWith(i)) {
              ...
              t.startsWith(n) &&
                (c.push({ type: 6, index: $ }), h.removeAttribute(t));
        if (v.test(h.tagName)) {
        ...
        if (h.data === o) c.push({ type: 2, index: $ });
          ...
          for (; -1 !== (t = h.data.indexOf(n, t + 1)); )
            c.push({ type: 7, index: $ }), (t += n.length - 1);
        }
      $++;
    }
  }
...
class S {
    ...
    const { values: e, _$litType$: s } = t,
      i =
        "number" == typeof s
          ? this._$AC(t)
          : (void 0 === s.el &&
              (s.el = b.createElement(N(s.h, s.h[0]), this.options)),
            s);
  ...
  k(t) {
    ...
    for (const n of t)
      i === e.length
        ? e.push((s = new S(this.S(l()), this.S(l()), this, this.options)))
        : (s = e[i]),
        s._$AI(n),
        i++;
  ...
  W = (t, e, s) => {
    ...
    if (void 0 === s) {
      ...
      if (r) {
        ...
        s._$AQ?.(t),
          (s._$AM = t),
          void 0 !== s._$AP && (e = t._$AU) !== o._$AU && s._$AP(e);
      }
      if (e !== n || r) {
        let t = s._$AA;
        for (; t !== e; ) {
      ...
      update(t, [e, s, i]) {
        ...
        for (; _ <= c && a <= d; )
          if (null === n[_]) _++;
            ...
            (l[d] = j(n[_], o[d])), W(t, l[d + 1], n[_]), _++, d--;
          else if (h[c] === r[a])
            (l[a] = j(n[c], o[a])), W(t, n[_], n[c]), c--, a++;
          else if (
            (void 0 === $ && (($ = Y(r, a, d)), (A = Y(h, _, c))), $.has(h[_]))
          )
            if ($.has(h[c])) {
              const e = A.get(r[a]),
                s = void 0 !== e ? n[e] : null;
